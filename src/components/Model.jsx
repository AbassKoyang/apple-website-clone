            ...
            <div id='con' className="flex flex-col items-center mt-10 relative">
                ...
                <div id='control-buttons-con' className="mt-16 flex-center flex-col sticky bottom-10 translate-y-[100px]">
                    ...
                    <div aria-label='Iphone color selector container' id='control-buttons-wrapper' className="scale-0 py-2.5 px-5 bg-gray-300 backdrop-blur rounded-full flex-center gap-3 mt-2.5 md:mt-3.5 w-fit">
                        ...
                        className={`${iphoneColor === 'all-colors' ? 'p-1 bg-white border-2 border-blue' : 'p-0 '} transition-all duration-300 ease-in-out rounded-full`}>
                        ...
                        className={`${iphoneColor === 'natural-titanium' ? 'p-1 bg-white border-2 border-blue' : 'p-0 '} transition-all duration-300 ease-in-out rounded-full`}>
                        <div 
                        ...
                        className={`${iphoneColor === 'blue-titanium' ? 'p-1 bg-white border-2 border-blue' : 'p-0 '} transition-all duration-300 ease-in-out rounded-full`}>
                        ...
                        className={`${iphoneColor === 'white-titanium' ? 'p-1 bg-white border-2 border-blue' : 'p-0 '} transition-all duration-300 ease-in-out rounded-full`}>
                        ...
                        className={`${iphoneColor === 'black-titanium' ? 'p-1 bg-white border-2 border-blue' : 'p-0 '} transition-all duration-300 ease-in-out rounded-full`}>
